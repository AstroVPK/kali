...
def set_plot_params(fontfamily='serif', fontstyle='normal', fontvariant='normal', fontweight='normal', fontstretch='normal', fontsize=20, useTex='False'):
    ...
    mpl.rcParams[
        'font.weight'] = fontweight  # 'light', 'normal', 'medium', 'semibold', 'bold', 'heavy', 'black'
    mpl.rcParams[
        'font.stretch'] = fontstretch  # ‘ultra-condensed’, ‘extra-condensed’, ‘condensed’, ‘semi-condensed’, ‘normal’, ‘semi-expanded’, ‘expanded’, ‘extra-expanded’, ‘ultra-expanded’
    mpl.rcParams[
