...
parser.add_argument('-n', '--name', type=str, default='211991001',
                    help=r'K2 ID from https://archive.stsci.edu/k2/data_search/search.php')
parser.add_argument('-c', '--campaign', type=str, default='c05',
                    help=r'K2 Campaign https://archive.stsci.edu/k2/data_search/search.php')
parser.add_argument('-processing', '--processing', type=str, default='vj',
                    help=r'What processing to use? eg. raw, pdcsap, uncal, mast, vandenburgjohnson etc...')
