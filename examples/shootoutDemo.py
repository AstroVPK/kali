...
plt.axvline(x = ThetaMock[0], ymin = 0, ymax = 1, color = '#e34a33')
plt.axhline(y = ThetaMock[1], xmin = 0, xmax = 1, color = '#e34a33')
...
plt.axvline(x = ThetaMock[2], ymin = 0, ymax = 1, color = '#e34a33')
plt.axhline(y = ThetaMock[3], xmin = 0, xmax = 1, color = '#e34a33')
if carma_pack_results_g:
