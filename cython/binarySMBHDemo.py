...
if __name__ == "__main__":
	...
	parser.add_argument('-omega', '--omega', type = float, default = 90.0, help = r'Argument of periapsis (degree), default = 0.0 degree')
	...
	A = bSMBH.bSMBH(rPer = args.rPer, m12 = args.m12, q = args.q, e = args.e, omega = args.omega, i = args.i, tau = args.tau, alpha1 = args.alpha1, alpha2 = args.alpha2)
	T = A.getPeriod()
	dt = T/numFrames
	...
	anim = animation.FuncAnimation(fig, animate, init_func = init, frames = numFrames, interval = intervalLen, blit = True)
